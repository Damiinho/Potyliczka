...
export const AppProvider = ({ children }) => {
  ...
  const [topics, setTopics] = useState([
    ...
    { name: "Deja vu", active: true, category: ["filmy"] },
    {
      name: "Death Note",
      active: true,
      category: ["filmy", "seriale", "kreskówki"],
    },
    ...
    { name: "Laboratorium Dextera", active: true, category: ["kreskówki"] },
    ...
    { name: "Dragon Ball", active: true, category: ["kreskówki"] },
    { name: "Droga do El Dorado", active: true, category: ["kreskówki"] },
    { name: "Droopy, superdetektyw", active: true, category: ["kreskówki"] },
    ...
    { name: "Ed, Edd i Eddy", active: true, category: ["kreskówki"] },
    ...
    { name: "Epoka lodowcowa", active: true, category: ["filmy", "kreskówki"] },
    ...
    { name: "Fineasz i Ferb", active: true, category: ["kreskówki"] },
    { name: "Flintstonowie ", active: true, category: ["kreskówki"] },
    ...
    { name: "Futurama", active: true, category: ["kreskówki"] },
    ...
    { name: "Garfield", active: true, category: ["filmy", "kreskówki"] },
    {
    ...
    { name: "Gumisie", active: true, category: ["kreskówki"] },
    ...
    { name: "Jak działa jamniczek", active: true, category: ["kreskówki"] },
    ...
    { name: "Jetsonowie", active: true, category: ["kreskówki"] },
    { name: "Jeździec bez głowy", active: true, category: ["filmy"] },
    { name: "Jeż Jerzy", active: true, category: ["filmy", "kreskówki"] },
    {
    ...
    { name: "Johnny Bravo", active: true, category: ["kreskówki"] },
    ...
    { name: "Kocia ferajna", active: true, category: ["kreskówki"] },
    ...
    { name: "Krowa i Kurczak", active: true, category: ["kreskówki"] },
    { name: "Król Lew", active: true, category: ["kreskówki"] },
    ...
    { name: "Kung Fu Panda", active: true, category: ["kreskówki"] },
    { name: "Laboratorium Dextera", active: true, category: ["kreskówki"] },
    ...
    { name: "Lilo i Stich", active: true, category: ["kreskówki"] },
    ...
    { name: "Magiczny autobus", active: true, category: ["kreskówki"] },
    ...
    { name: "Mérida waleczna", active: true, category: ["kreskówki"] },
    { name: "Miasteczko South Park", active: true, category: ["kreskówki"] },
    ...
    { name: "Miś Uszatek", active: true, category: ["kreskówki"] },
    { name: "Mój brat niedźwiedź ", active: true, category: ["kreskówki"] },
    { name: "Mulan", active: true, category: ["kreskówki"] },
    { name: "Muminki", active: true, category: ["kreskówki"] },
    ...
    { name: "Pingwiny z Madagaskaru", active: true, category: ["kreskówki"] },
    { name: "Pinky i Mózg", active: true, category: ["kreskówki"] },
    ...
    { name: "Potwory i spółka", active: true, category: ["kreskówki"] },
    ...
    { name: "Przygody kota Filemona", active: true, category: ["kreskówki"] },
    ...
    { name: "Ralph Demolka", active: true, category: ["kreskówki"] },
    { name: "Rambo (seria)", active: true, category: ["filmy"] },
    { name: "Ranczo", active: true, category: ["seriale"] },
    { name: "Ratatuj", active: true, category: ["kreskówki"] },
    ...
    { name: "Scooby Doo", active: true, category: ["kreskówki"] },
    {
    ...
    { name: "Simpsonowie", active: true, category: ["kreskówki"] },
    ...
    { name: "Smerfy", active: true, category: ["kreskówki"] },
    { name: "SpongeBob Kanciastoporty", active: true, category: ["kreskówki"] },
    { name: "Sonic X", active: true, category: ["kreskówki"] },
    ...
    { name: "Świat według Ludwiczka", active: true, category: ["kreskówki"] },
    { name: "Święta wojna", active: true, category: ["seriale"] },
    { name: "Świnka Peppa", active: true, category: ["kreskówki"] },
    ...
    { name: "Toy Story", active: true, category: ["kreskówki"] },
    ...
    { name: "W.I.T.C.H. Czarodziejki", active: true, category: ["kreskówki"] },
    { name: "W chmurach", active: true, category: ["filmy"] },
    { name: "W garniturach", active: true, category: ["seriale"] },
    { name: "W głowie się nie mieści", active: true, category: ["kreskówki"] },
    { name: "W11 - Wydział Śledczy", active: true, category: ["seriale"] },
    { name: "WALL·E", active: true, category: ["kreskówki"] },
    ...
    { name: "Włatcy móch", active: true, category: ["kreskówki"] },
    {
    ...
    { name: "Wyspa Totalnej Porażki", active: true, category: ["kreskówki"] },
    ...
    { name: "Zaplątani", active: true, category: ["kreskówki"] },
    ...
    { name: "Zwariowane Melodie ", active: true, category: ["kreskówki"] },
